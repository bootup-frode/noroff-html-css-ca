...
window.alert(document.getElementById('headerNavWrapper').offsetHeight + "px");
document.getElementById("headerNavSupport").style.height=document.getElementById('headerNavWrapper').offsetHeight + "px";
}